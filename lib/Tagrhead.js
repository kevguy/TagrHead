...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TagrHead = __webpack_require__(1);
	
	var _TagrHead2 = _interopRequireDefault(_TagrHead);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	module.exports = _TagrHead2.default; /*
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bloodhoundMin = __webpack_require__(2);
	
	var _bloodhoundMin2 = _interopRequireDefault(_bloodhoundMin);
	
	var _typeaheadBundleMin = __webpack_require__(4);
	
	var _typeaheadBundleMin2 = _interopRequireDefault(_typeaheadBundleMin);
	
	var _rxAll = __webpack_require__(7);
	
	var _rxAll2 = _interopRequireDefault(_rxAll);
	...
	var Tagrhead = function () {
	  function Tagrhead(dataSources) {
	    var containerDivId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '#tagrhead-container';
	    var el = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '#tagrhead-input';
	  ...
	  _createClass(Tagrhead, [{
	    key: 'createBloodHoundConfig',
	    value: function createBloodHoundConfig(dataSource) {
	      return {
	    ...
	    key: 'createSingleBloodHoundInitStream',
	    value: function createSingleBloodHoundInitStream(bh, dataSource) {
	      return _rxAll2.default.Observable.fromPromise(bh.initialize()).map(function (response) {
	        return {
	          name: dataSource.name,
	          displayKey: dataSource.displayKey,
	          source: bh.ttAdapter(),
	          templates: {
	            header: dataSource.template || '<h5 class="">' + dataSource.name + '</h5>'
	          }
	        };
	      });
	    }
	  }, {
	    key: 'createBloodHoundsStream',
	    value: function createBloodHoundsStream() {
	      var _this = this,
	          _Rx$Observable;
	      ...
	      this.dataSources.map(function (dataSource) {
	        var bh = new _bloodhoundMin2.default(_this.createBloodHoundConfig(dataSource));
	        var stream = _this.createSingleBloodHoundInitStream(bh, dataSource);
	
	        streams.push(stream);
	        _this.bloodHounds.set([dataSource.name, bh]);
	      });
	      return (_Rx$Observable = _rxAll2.default.Observable).merge.apply(_Rx$Observable, streams);
	    }
	  }, {
	    key: 'createTypeAheadStream',
	    value: function createTypeAheadStream() {
	      var _this2 = this;
	
	      var stream = this.createBloodHoundsStream().do(function (response) {
	        _this2.typeaheadArr.push(response);
	      }).last();
	    ...
	    key: 'createTypeAhead',
	    value: function createTypeAhead() {
	      var _this3 = this;
	
	      var stream = this.createTypeAheadStream();
	
	      this.subscription = stream.subscribe(function (response) {}, function (err) {
	        console.log(err);
	      }, function () {
	        var _$;
	
	        $(_this3.el).innerHTML = '';
	        _this3.typeaheadSrch = (_$ = $(_this3.el)).typeahead.apply(_$, [{
	          hint: true,
	          highlight: true,
	          minLength: 0
	        }].concat(_toConsumableArray(_this3.typeaheadArr)));
	    ...
	    key: 'getTypeAheadObj',
	    value: function getTypeAheadObj() {
	      return this.typeaheadSrch;
	    }
	  }, {
	    key: 'createTags',
	    value: function createTags() {
	      this.tags = new _Tags2.default(this.containerDivId, this.el);
	    }
	  }, {
	    key: 'stop',
	    value: function stop() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(8)(module), (function() { return this; }()), __webpack_require__(6)))
...
/***/ function(module, exports) {
	...
	*/
	...
	var Tags = function () {
	  function Tags(containerDivId, inputId) {
	    var _this = this;
	    ...
	    this.removeBtnHandler = function (e) {
	      e.preventDefault();
	      if (e.target.className === 'tag__remove') {
	        var tag = e.target.parentNode;
	        var name = _$('.tag__name', tag);
	
	        _this.wrap.removeChild(tag);
	        _this.tagsArray.splice(_this.tagsArray.indexOf(name.textContent), 1);
	        _this.el.value = _this.tagsArray.join(',');
	      }
	      _this.field.focus();
	    };
	    ...
	    this.keyHandler = function (e) {
	      ...
	      if (e.target.tagName === 'INPUT') {
	        (function () {
	          ...
	          if (_this.field.previousSibling && code !== _this.KEYS.BACK) {
	            // console.log(this.field.previousSibling);
	            _removeClass('tag--marked', _this.field.previousSibling);
	          }
	
	          var name = target.value.trim();
	
	          if (code === _this.KEYS.ENTER) {
	            // console.log('enter');
	            target.blur();
	            // this.addTag(name);
	          ...
	          } else if (code === _this.KEYS.BACK) {
	            if (e.target.value === '' && !_this.isPressed) {
	  ...
	  _createClass(Tags, [{
	    ...
	    value: function hasTags() {
	      ...
	      var arr = this.el.value.trim().split(',');
	
	      arr.forEach(function (item) {
	        item = item.trim();
	        if (~_this2.tagsArray.indexOf(item)) {
	          // equivalent to this.tagsArray.indexOf(item) >= 0
	          return;
	        }
	        var tag = _this2.createTag(item);
	
	        _this2.tagsArray.push(item);
	        _this2.wrap.insertBefore(tag, _this2.field);
	      });
	    }
	  }, {
	    key: 'createTag',
