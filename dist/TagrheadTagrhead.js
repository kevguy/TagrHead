...
var SuggestionProvider = function () {
  ...
  _createClass(SuggestionProvider, [{
    ...
    value: function init(dataSources) {
      ...
      Promise.all(bloodhounds).then(function () {
        console.log('bloodhounds ready to go');
      }).catch(function (err) {
...
!function(a,b){ true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(6)], __WEBPACK_AMD_DEFINE_RESULT__ = function(c){return a.Bloodhound=b(c)}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
//# sourceMappingURL=TagrheadTagrhead.js.map